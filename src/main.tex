...
\usepackage{lib/texcc}          % Adaptações as normas da FACENS
...
\imprimirfichacatalografica{main/ficha_catalografica.pdf}

% ---
% Inserir errata
% ---
\input{main/errata.tex}
% ---
...
%
\input{main/folha_aprovacao.tex}
% ---

% ---
% Dedicatória
% ---
\input{main/dedicatoria.tex}
% ---

% ---
% Agradecimentos
% ---
\input{main/agradecimentos.tex}
% ---

% ---
% Epígrafe
% ---
\input{main/epigrafe.tex}
% ---
...
% ----------------------------------------------------------
\input{main/introducao.tex}

% ----------------------------------------------------------
% PARTE
% ----------------------------------------------------------
\input{main/preparacao_pesquisa.tex}
\input{main/referenciais_teoricos.tex}
\input{main/resultados.tex}
...
% Apêndices
% ----------------------------------------------------------
\input{main/apendices.tex}

% ----------------------------------------------------------
% Anexos
% ----------------------------------------------------------
\input{main/anexos.tex}
