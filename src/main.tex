...
%% \input{partes/pre_textuais/ficha_catalografica.tex}
%% \input{partes/pre_textuais/folha_aprovacao.tex}
%% \input{partes/pre_textuais/agradecimentos.tex}
%% \input{partes/pre_textuais/epigrafe.tex}
...
%% \input{partes/pre_textuais/lista_tabelas.tex}
\input{partes/pre_textuais/lista_siglas.tex}
...
\input{partes/textuais/carros_autonomos.tex}
\input{partes/textuais/inteligencia_artificial.tex}
\input{partes/textuais/neat.tex}
\input{partes/textuais/metodologias.tex}
