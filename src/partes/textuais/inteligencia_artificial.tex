...
simula{\c c}{\~a}o quanto o algoritmo de aprendizado
simultaneamente. Neste caso, a aplica{\c c}{\~a}o de um m{\'e}todo
heur{\'i}stico nas itera{\c c}{\~o}es pode beneficiar o sistema na
coordena{\c c}{\~a}o de novos cen{\'a}rios. Al{\'e}m disso, metodos
